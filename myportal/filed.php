...
users a INNER JOIN filed b ON a.userid = b.userid INNER JOIN attendance c ON b.attendanceid = c.attendanceid WHERE b.userid = :uid");
$requests->execute(array(':uid'=>$userdata));
...
?>
    ...
    <tr style="font-size: 11px">
     ...
     <!-- <td> <a class="approvalbutton" href="" >YES</a> | <a class="approvalbutton" href="">NO</td>-->
      <td><a class="approvalbutton" href="filed.php?id=<?php echo $row_requests['fileid'];?>" >VIEW</a> </td>
