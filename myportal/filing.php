...
$mn_timecard=$conn->prepare("SELECT b.attendanceid,a.firstname,a.lastname,b.date_in,b.time_in,b.date_out,b.time_out FROM users a INNER JOIN attendance b ON a.userid = b.userid WHERE a.userid = :uid GROUP BY b.date_in,b.time_in ORDER BY b.date_in DESC,b.time_in DESC");
